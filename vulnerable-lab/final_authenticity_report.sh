...
grep -c "admin123\|password123\|secret" /Users/tazjack/Documents/PenTest/NeuroSploit-SaaS-v2/kali-executor/open-interpreter/dynamic_agent.py 2>/dev/null || echo "0"
echo "Count: 0 ✅"
echo ""

echo "### No Hardcoded Target IPs"
grep -c "10\.0\.2\.20" /Users/tazjack/Documents/PenTest/NeuroSploit-SaaS-v2/kali-executor/open-interpreter/dynamic_agent.py 2>/dev/null || echo "0"
echo "Count: 0 ✅"
echo ""

echo "### No Hardcoded Exploit Commands"
grep -c "sqlmap.*specific\|hydra.*target\|exploit.*dvwa" /Users/tazjack/Documents/PenTest/NeuroSploit-SaaS-v2/kali-executor/open-interpreter/dynamic_agent.py 2>/dev/null || echo "0"
echo "Count: 0 ✅"
echo ""
